...
export const Landing = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      desc: 'Extract and analyze skills gaps, discover suitable job roles, and receive customized multi-phase learning paths.',
      icon: Compass,
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-6 flex flex-col justify-center py-20 z-10 relative">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold font-sans leading-tight tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-400">
            Elevate Your Career with an <br className="hidden md:block"/>
          ...
          <p className="mt-6 text-slate-400 md:text-lg max-w-2xl mx-auto leading-relaxed">
            Upload your resume, analyze ATS scores, map missing skills, simulate actual job interviews, and receive structured career roadmaps automatically.
          </p>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              <span>Build Your Roadmap Now</span>
              <ArrowRight size={18} />
            </Link>
            <Link
